...
**wq/pandas.js** is a [wq.app module] providing a simple utility to load and parse CSV files generated by Pandas dataframes.  wq/pandas.js extends d3's built in CSV parser with a more robust way to handle the complex CSV headers Pandas DataFrames can produce.  wq/pandas.js is primarily intended for use in conjunction with [Django REST Pandas].
